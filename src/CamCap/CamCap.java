...
public class CamCap extends javax.swing.JFrame {
    ...
    String faceFile = "haarcascade_speaker.xml";  // Archivo referencia para reconocimiento de rostros
                ...
                while (runnable) {
                    if (webSource.grab()) {
                        try {
                            ...
                            faceDetector.detectMultiScale(frame, faceDetections,8.5,30,1,a); // Se buscan las caras dentro de la imagen y se guardan en faceDetections
//                            faceDetector.
                            int i= 0;
